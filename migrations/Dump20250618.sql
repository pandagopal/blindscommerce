...
INSERT INTO `product_categories` VALUES (243,2,1,'2025-06-18 06:13:03'),(243,21,0,'2025-06-18 06:13:03'),(243,22,0,'2025-06-18 06:13:03');
...
CREATE TABLE `product_colors` (
  ...
  `is_available` tinyint(1) DEFAULT '1',
  `swatch_image` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `display_order` int DEFAULT '0',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`),
...
INSERT INTO `product_fabric_images` VALUES (109,69,243,'/uploads/vendor/2/product_243_c81e728d_1750222327035_f7vag5yi5pk.jpg','Image 0',NULL,NULL,NULL,0,0,'2025-06-18 06:13:03','2025-06-18 06:13:03'),(110,70,243,'/uploads/vendor/2/product_243_c81e728d_1750222327057_hd1o2pju9jg.png','Image 0',NULL,NULL,NULL,0,0,'2025-06-18 06:13:03','2025-06-18 06:13:03');
...
INSERT INTO `product_fabric_options` VALUES (69,243,2,'sheer','Test Fabric 2',1,'','2025-06-18 06:13:03','2025-06-18 06:13:03'),(70,243,2,'blackout','Test Fabric 1',1,'','2025-06-18 06:13:03','2025-06-18 06:13:03');
...
INSERT INTO `product_fabric_pricing` VALUES (699,69,243,1.000,120.000,NULL,NULL,20.0000,1,0,NULL,NULL,'2025-06-18 06:13:03','2025-06-18 06:13:03'),(700,70,243,1.000,120.000,NULL,NULL,10.0000,1,0,NULL,NULL,'2025-06-18 06:13:03','2025-06-18 06:13:03');
...
INSERT INTO `product_images` VALUES (1,243,'/uploads/products/product_243_1750195341922_b337o93yu6.png',NULL,0,0,'2025-06-18 06:13:03','2025-06-18 06:13:03');
...
CREATE TABLE `product_materials` (
  ...
  `maintenance_level` enum('low','medium','high') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'medium',
  `is_eco_friendly` tinyint(1) DEFAULT '0',
  `is_available` tinyint(1) DEFAULT '1',
  `sample_available` tinyint(1) DEFAULT '1',
  `texture_image` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`),
  KEY `material_type` (`material_type`),
...
INSERT INTO `product_pricing_matrix` VALUES (99,243,11.00,20.00,11.00,20.00,10.00,0.00,NULL,NULL,1,'2025-06-18 06:13:03'),(100,243,31.00,40.00,21.00,30.00,20.00,0.00,NULL,NULL,1,'2025-06-18 06:13:03'),(101,243,51.00,60.00,31.00,40.00,30.00,0.00,NULL,NULL,1,'2025-06-18 06:13:03'),(102,243,61.00,70.00,101.00,110.00,80.00,0.00,NULL,NULL,1,'2025-06-18 06:13:03'),(103,243,71.00,80.00,41.00,50.00,50.00,0.00,NULL,NULL,1,'2025-06-18 06:13:03'),(104,243,91.00,100.00,61.00,70.00,60.00,0.00,NULL,NULL,1,'2025-06-18 06:13:03');
...
INSERT INTO `product_rooms` VALUES (8,243,'Media Room',1,'dsd','2025-06-18 06:13:03');
...
-- Dump completed on 2025-06-18 10:12:23
