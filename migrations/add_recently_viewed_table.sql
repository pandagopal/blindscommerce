-- Add recently_viewed table migration
-- This migration adds the missing recently_viewed table and its triggers
...
SELECT 'Recently viewed table and triggers created successfully' AS Status;