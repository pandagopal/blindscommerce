...
export async function POST(request: NextRequest) {
  try {
    ...
    const [existingVendorProduct] = await pool.execute<RowDataPacket[]>(
    ...
    const [cloneResult] = await pool.execute<ResultSetHeader>(
    ...
    const [pricingRows] = await pool.execute<RowDataPacket[]>(
