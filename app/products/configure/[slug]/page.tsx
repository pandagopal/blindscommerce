...
import { ChevronRight, ChevronLeft, Check, ChevronDown, HelpCircle, ShoppingCart, Info } from "lucide-react";
        ...
        return (
          <div>
            ...
            <div className="mt-4">
              <button
                onClick={addToCart}
                className="flex items-center justify-center w-full bg-primary-red hover:bg-primary-red-dark text-white font-medium py-3 px-6 rounded-lg transition-colors"
              >
