...
const CollapsibleSection = ({
  ...
  return (
    <div className={`bg-white rounded-xl shadow-lg border transition-all duration-300 ${
      isExpanded ? 'border-red-500 shadow-red-100' : isCompleted ? 'border-green-200' : 'border-gray-100'
    }`}>
              ...
              {recommendations.map((rec, index) => (
                ...
                >
                  <rec.icon size={18} className={`mt-0.5 flex-shrink-0 ${
                    ...
                    rec.type === 'suggestion' ? 'text-red-600' :
                    'text-gray-600'
                  }`} />
                  <div className="flex-1">
                    <p className={`text-sm font-medium ${
                      rec.type === 'warning' ? 'text-amber-800' :
                      rec.type === 'suggestion' ? 'text-red-800' :
                      'text-gray-800'
                    }`}>{rec.title}</p>
                    <p className={`text-xs mt-0.5 ${
                      rec.type === 'warning' ? 'text-amber-700' :
                      rec.type === 'suggestion' ? 'text-red-700' :
                      'text-gray-600'
                    }`}>{rec.message}</p>
                  </div>
                </div>
...
export default function NewProductConfigurator({ product, slug, onAddToCart, initialConfig = {}, isEditMode = false, userRole, roomTypes = [], onConfigurationChange }: ProductConfiguratorProps) {
  ...
  const getBgClass = (fabricType: string | undefined) => {
    switch(fabricType?.toLowerCase()) {
      ...
      case 'designer': return 'from-rose-100 to-rose-200';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-red-50">
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="mb-6">
          <Link
            href="/products"
            className="inline-flex items-center text-red-600 hover:text-red-800 transition-colors text-sm font-medium group"
          >
          ...
          <div className="space-y-3 lg:h-auto">
            ...
            >
              <select
                ...
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all text-gray-700 ${
            ...
            >
              <div className="space-y-2">
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all flex-shrink-0 ${
                      config.mountType === 'inside' ? 'border-red-500 bg-red-500' : 'border-gray-300'
                    }`}>
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-rose-100 to-rose-200 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all flex-shrink-0 ${
                      config.mountType === 'outside' ? 'border-red-500 bg-red-500' : 'border-gray-300'
                    }`}>
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          placeholder="0"
                          className={`w-24 p-2 border rounded-lg focus:ring-2 focus:ring-red-500 ${
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    ...
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-8 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm"
                      />
                      {fabricSearch && (
                        <button
                    ...
                    >
                      ...
                      Filters
                      {opacityFilter !== 'all' && (
                        <span className="ml-2 bg-red-600 text-white text-xs px-1.5 py-0.5 rounded">1</span>
                      )}
                    </button>
                  </div>
                          ...
                          .map((system: any) => {
                            ...
                            return (
                              <label key={controlId} className={`flex items-start p-3 border rounded-lg cursor-pointer transition-all ${
                                config.controlOption === controlId ? 'border-red-500 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                              }`}>
                                <input
                                  type="radio"
                                  name="controlOption"
            ...
            <div className="space-y-2 md:space-y-0 md:flex md:gap-2">
              {userRole === 'customer' ? (
                <button
                  ...
                  className={`w-full md:flex-1 font-semibold py-3 px-5 rounded-lg transition-all shadow-lg flex items-center justify-center ${
                    areMandatoryFieldsComplete()
                      ? 'bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white hover:shadow-xl cursor-pointer'
                ...
                <div className="w-full md:flex-1 bg-yellow-50 border border-yellow-200 rounded-lg py-3 px-5 text-center">
                  ...
                  <Link
                    href="/login"
                    className="inline-flex items-center bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg"
                  >
              ...
              {userRole === 'customer' && (
                <Link href="/cart" className="block w-full md:w-auto">
                  <button className="w-full md:w-auto font-semibold py-3 px-5 rounded-lg border-2 border-gray-300 hover:border-red-600 text-gray-700 hover:text-red-600 flex items-center justify-center">
                    <ShoppingCart size={16} className="mr-2" />
                    View Cart
                    {itemCount > 0 && (
                      <span className="ml-2 bg-red-600 text-white text-xs rounded-full px-2 py-1">({itemCount})</span>
                    )}
                  </button>
                </Link>
              )}
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="bg-white rounded-lg p-3 text-center shadow-sm">
                <Truck className="w-6 h-6 text-red-600 mx-auto mb-1" />
          ...
          <div className="lg:sticky lg:top-4 lg:h-[calc(100vh-2rem)] lg:overflow-y-auto space-y-3">
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 border border-gray-100">
              <div className="flex items-center mb-3">
                <Sparkles className="text-red-600 mr-2" size={20} />
