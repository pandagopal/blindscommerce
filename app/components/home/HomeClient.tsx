...
export default function HomeClient({ categories, products }: HomeClientProps) {
  ...
  return (      <main className="min-h-screen">
                  ...
                  <div className="container mx-auto px-4">
                    <div className="max-w-lg text-white">
                      ...
                      <div className="flex gap-4">
                        <Link 
                          href="/products" 
                          className="bg-primary-red hover:bg-[#B91C1C] text-white px-8 py-3 rounded-full font-semibold transition-colors shadow-lg hover:shadow-xl"
                        >
                          Shop Now
                        </Link>
                        <Link 
              ...
              <div className="absolute inset-0 flex items-center">
                <div className="container mx-auto px-4">
                  <div className="max-w-lg text-white">
                    ...
                    <Link href="/products/shades" className="bg-primary-red hover:bg-primary-red-dark text-white px-8 py-3 rounded-full font-semibold transition-colors inline-block">
                      Shop Shades
                    </Link>
                  </div>
                </div>
      ...
      {/* Rest of the sections */}        {/* Promotion Banner Strip */}
        <section className="bg-[#CC2229] text-white py-4">
          <div className="container mx-auto px-4">
