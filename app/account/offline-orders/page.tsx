...
const statusConfig: Record<string, { label: string; color: string; icon: React.ReactNode }> = {
  ...
  'order_finished': { label: 'Order Finished', color: 'bg-purple-100 text-primary-dark', icon: <CheckCircle className="h-4 w-4" /> },
  'sent_to_shipping': { label: 'Sent to Shipping', color: 'bg-indigo-100 text-primary-dark', icon: <Truck className="h-4 w-4" /> },
