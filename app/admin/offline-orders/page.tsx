...
const statusConfig: Record<string, { label: string; color: string; icon: React.ComponentType<any> }> = {
  ...
  'order_finished': { label: 'Order Finished', color: 'bg-purple-100 text-purple-700', icon: CheckCircle },
  'sent_to_shipping': { label: 'Sent to Shipping', color: 'bg-indigo-100 text-indigo-700', icon: Truck },
